 ...
 var waistNum, neckNum, heightNum, hipNum, genderId, newEditBtn, a, addDataTable,formId, percentFat, Log10, bf, chartType, ctx, myChart;
 waistNum = 32;
 neckNum = 12;
 heightNum = 65;
 hipNum = 35;
 ...
 //         expect(allCode).toContain(console.log("text"));
 //     });
 // });
